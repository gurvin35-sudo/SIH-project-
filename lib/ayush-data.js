...
export const ASHTAVIDHA_PARIKSHA = {
  nadi: {
    labelEn: 'Pulse Examination (Nadi Pariksha)',
    labelHi: 'नाड़ी परीक्षा (Pulse)',
    options: [
      { id: 'sarpa_vata', labelEn: 'Snake-like / Fast & irregular (Sarpa Gati - Vata)', labelHi: 'सर्प गति (वात प्रधान - चंचल व तीव्र)' },
      { id: 'manduka_pitta', labelEn: 'Frog-like / Jumping & bounding (Manduka Gati - Pitta)', labelHi: 'मण्डूक गति (पित्त प्रधान - उछलने वाली)' },
      { id: 'hamsa_kapha', labelEn: 'Swan/Elephant / Slow & steady (Hamsa/Gaja Gati - Kapha)', labelHi: 'हंस/गज गति (कफ प्रधान - मन्द व स्थिर)' },
      { id: 'vata_pitta', labelEn: 'Combined: Fast & warm (Vata-Pitta Gati)', labelHi: 'द्विदोषज: वात-पित्त गति' },
      { id: 'pitta_kapha', labelEn: 'Combined: Full & warm (Pitta-Kapha Gati)', labelHi: 'द्विदोषज: पित्त-कफ गति' },
      { id: 'sama_tridosha', labelEn: 'Balanced / Normal rhythm (Tridosha Sama)', labelHi: 'सम / त्रिदोष सम गति' },
    ],
  },
  jihva: {
    labelEn: 'Tongue Examination (Jihva Pariksha)',
    labelHi: 'जिह्वा परीक्षा (Tongue)',
    options: [
      { id: 'sama_coated', labelEn: 'White thick coat / Toxic buildup (Sama Jihva / Ama)', labelHi: 'साम जिह्वा (सफेद मोटी परत - आम दोष)' },
      { id: 'nirama_clean', labelEn: 'Clean, pink & healthy (Nirama Jihva)', labelHi: 'निराम जिह्वा (स्वच्छ, गुलाबी, स्वस्थ)' },
      { id: 'dry_cracked', labelEn: 'Dry, cracked & rough (Ruksha / Vata)', labelHi: 'रुक्ष / स्फुटित (सूखी, फटी हुई - वात)' },
      { id: 'red_burning', labelEn: 'Red, inflamed / Yellowish coat (Rakta / Pitta)', labelHi: 'रक्त / पीताभ (लाल, पीले धब्बे - पित्त)' },
      { id: 'pale_moist', labelEn: 'Pale, excessively moist & thick (Pandu / Kapha)', labelHi: 'पाण्डु / स्निग्ध (पीली, अत्यधिक गीली - कफ)' },
    ],
  },
  mala: {
    labelEn: 'Stool Examination (Mala Pariksha)',
    labelHi: 'मल परीक्षा (Stool / Bowel)',
    options: [
      { id: 'vibandha_constipation', labelEn: 'Hard, dry & constipated (Vibandha / Vata)', labelHi: 'विबन्ध / ग्रथित (कठोर, सूखा, कब्ज - वात)' },
      { id: 'athisara_loose', labelEn: 'Loose, frequent & burning (Drava / Pitta)', labelHi: 'द्रव / पीताभ (पतला, पीला, जलन युक्त - पित्त)' },
      { id: 'ama_sinking', labelEn: 'Sticky, foul odor & mucus (Ama Yukta / Kapha)', labelHi: 'साम युक्त / गुरु (चिपचिपा, दुर्गंध, भारी - आम)' },
      { id: 'prakruta_normal', labelEn: 'Well formed, floats & non-sticky (Normal / Nirama)', labelHi: 'प्राकृत / निराम (बंधा हुआ, तैरने वाला, सामान्य)' },
    ],
  },
  mutra: {
    labelEn: 'Urine Examination (Mutra Pariksha)',
    labelHi: 'मूत्र परीक्षा (Urine)',
    options: [
      { id: 'alpa_varna', labelEn: 'Scanty, clear/frothy & irregular (Alpa / Vata)', labelHi: 'अल्प / श्यामाभ (कम, झागदार - वात)' },
      { id: 'pitabha_burning', labelEn: 'Yellow/reddish with burning sensation (Pitabha / Pitta)', labelHi: 'पीताभ / दाह (पीला/लाल, मूत्र त्याग में जलन - पित्त)' },
      { id: 'avila_frothy', labelEn: 'Cloudy, turbid & heavy (Avila / Kapha)', labelHi: 'आविल / श्वेताभ (धुंधला, झागयुक्त, गाढ़ा - कफ)' },
      { id: 'prakruta_mutra', labelEn: 'Pale clear yellow & painless (Normal / Prakruta)', labelHi: 'प्राकृत (हल्का पीला, साफ, सामान्य)' },
    ],
  },
  sparsha: {
    labelEn: 'Skin & Touch Examination (Sparsha Pariksha)',
    labelHi: 'स्पर्श परीक्षा (Touch / Skin Temperature)',
    options: [
      { id: 'ruksha_sheeta', labelEn: 'Dry, rough & cold to touch (Ruksha / Vata)', labelHi: 'रुक्ष एवं शीत (सूखा, खुरदरा, ठंडा - वात)' },
      { id: 'ushna_sweda', labelEn: 'Warm, perspiring & burning (Ushna / Pitta)', labelHi: 'उष्ण एवं स्वेदयुक्त (गर्म, पसीनेदार, जलन - पित्त)' },
      { id: 'snigdha_sheeta', labelEn: 'Oily, smooth, cold & clammy (Snigdha / Kapha)', labelHi: 'स्निग्ध एवं शीत (चिकना, कोमल, शीतल - कफ)' },
      { id: 'sama_sparsha', labelEn: 'Normal temperature & soft texture (Sama Sparsha)', labelHi: 'सम स्पर्श (सामान्य तापमान एवं स्पर्श)' },
    ],
  },
  druk: {
    labelEn: 'Eye & Vision Examination (Druk Pariksha)',
    labelHi: 'दृक परीक्षा (Eyes / Sclera)',
    options: [
      { id: 'ruksha_astira', labelEn: 'Dry, dull, unsteady & dark circles (Ruksha / Vata)', labelHi: 'रुक्ष / अस्थिर (सूखी, चमकहीन, चंचल दृष्टि - वात)' },
      { id: 'rakta_pitabha', labelEn: 'Red / Yellowish tint & burning (Rakta / Pitta)', labelHi: 'रक्त / पीताभ (लाल, पीली आभा, जलन - पित्त)' },
      { id: 'shweta_snigdha', labelEn: 'White, moist, clear & thick lashes (Snigdha / Kapha)', labelHi: 'श्वेत / स्निग्ध (सफेद, चमकदार, नम - कफ)' },
      { id: 'prakruta_druk', labelEn: 'Clear vision & normal sclera (Normal / Prakruta)', labelHi: 'प्राकृत दृक (स्वस्थ एवं सामान्य दृष्टि)' },
    ],
  },
  shabda: {
    labelEn: 'Voice & Speech Examination (Shabda Pariksha)',
    labelHi: 'शब्द परीक्षा (Voice / Speech)',
    options: [
      { id: 'kheena_sphuta', labelEn: 'Hoarse, feeble, fast or broken (Ksheena / Vata)', labelHi: 'क्षीण / स्फुटित (कर्कश, टूटी हुई, तेज आवाज - वात)' },
      { id: 'teekshna_spashta', labelEn: 'Sharp, loud, clear & commanding (Teekshna / Pitta)', labelHi: 'तीक्ष्ण / उग्र (तेज, स्पष्ट, रोबीली आवाज - पित्त)' },
      { id: 'gambhira_mandra', labelEn: 'Deep, resonant, heavy & calm (Gambhira / Kapha)', labelHi: 'गम्भीर / मन्द्र (भारी, गहरी, मधुर आवाज - कफ)' },
    ],
  },
  aakriti: {
    labelEn: 'Body Build & Posture Examination (Aakriti Pariksha)',
    labelHi: 'आकृति परीक्षा (General Posture & Build)',
    options: [
      { id: 'krisha_chala', labelEn: 'Thin/Slender, stooped & restless gait (Krisha / Vata)', labelHi: 'कृश / चल (पतला शरीर, चंचल चाल - वात)' },
      { id: 'madhyama_tejas', labelEn: 'Medium posture, bright & assertive (Madhyama / Pitta)', labelHi: 'मध्यम / तेजस्वी (संतुलित ढांचा, तेजवान मुख - पित्त)' },
      { id: 'sthula_dhira', labelEn: 'Heavy/Robust build & steady graceful gait (Sthula / Kapha)', labelHi: 'स्थूल / स्थिर (मजबूत शरीर, स्थिर चाल - कफ)' },
    ],
  },
};
