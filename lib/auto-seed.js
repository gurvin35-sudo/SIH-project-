...
export async function ensureDatabaseSeeded(prisma) {
  ...
  try {
    ...
    // 1. Ensure SQLite Tables exist on serverless (/tmp/dev.db)
    ...
    await prisma.$executeRawUnsafe(`
      CREATE TABLE IF NOT EXISTS "Patient" (
        ...
        "allergies" TEXT,
        "prakritiType" TEXT,
        "preConsultationStatus" TEXT NOT NULL DEFAULT 'PENDING',
    ...
    await prisma.$executeRawUnsafe(`
      CREATE TABLE IF NOT EXISTS "MedicalDocument" (
        ...
        "extractedData" TEXT,
        "summary" TEXT,
        "uploadedBy" TEXT NOT NULL DEFAULT 'patient',
        "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
        "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    await prisma.$executeRawUnsafe(`
      CREATE TABLE IF NOT EXISTS "CaseRecord" (
        ...
        "prakritiResult" TEXT,
        "prakritiAnswers" TEXT,
        "nadiPariksha" TEXT,
        "jihvaPariksha" TEXT,
        "malaPariksha" TEXT,
        "mutraPariksha" TEXT,
        "sparshaPariksha" TEXT,
        "drukPariksha" TEXT,
        "shabdaPariksha" TEXT,
        "aakritiPariksha" TEXT,
        "agniType" TEXT,
        "koshtaType" TEXT,
    ...
    console.log('🌱 Database empty on serverless! Auto-seeding default Doctor & Patient records...');
    ...
    // 4. Patients & Multi-Visit Cases Data
    const patientsData = [
      {
    ...
    console.log('✅ Auto-seed completed successfully with DDL verification!');
  } catch (err) {
